...
```{attention}
ALL students must do Part 1 Step 1 to set up a new Cocalc project for NSCI0036.
...
1. Click 'Sign Up'.
1. Agree to the terms of service then create an account using your long-form UCL email address `firstname.surname.22@ucl.ac.uk`.
1. You should see a Project titled something like '[your name] - NSCI0036_23_24'. If you don't, this might be because you didn't use the correct email address in step 3.
...
1. To add your partner as a collaborator, click on your name then enter your partner's full name or email address (in the form `firstname.surname.22@ucl.ac.uk`) in the box.
